...
<nav>
  <div class="nav-in">
    ...
    <ul class="nav-links">
      ...
      <li><a href="aulas.html">Aulas Particulares</a></li>
      <li><a href="samba.html">Samba sem Mistério</a></li>
...
<div id="mmenu">
  ...
  <a href="aulas.html">Aulas Particulares</a>
  <a href="samba.html">Samba sem Mistério</a>
...
function initTracking() {
  ...
  document.querySelectorAll('a[href*="wa.me"]').forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      const cname = page === 'aulas.html' ? 'Aulas Particulares' : 'Samba sem Mistério';
